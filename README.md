...
If Android does not offer installation, tap the **Full screen** button in the upper-right corner of the website. The browser must allow fullscreen requests from a direct user tap. Android's Back gesture or the same button exits fullscreen.
